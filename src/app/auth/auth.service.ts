...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-339211:/callback' : 'http://localhost:8100/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-339211:/logout' : 'http://localhost:8100/implicit/logout';
    const clientId = '0oa2blmqo4BzqqDbc357';
    const issuer = 'https://dev-339211.okta.com/oauth2/default';
